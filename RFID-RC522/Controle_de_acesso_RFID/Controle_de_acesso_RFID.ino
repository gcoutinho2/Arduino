...
String TagsCadastradas[] = {"e1dcc42d", 
                            "ID_2",
                            "ID_3"};
...
void setup() {
        ...
        LeitorRFID.PCD_SetAntennaGain(LeitorRFID.RxGain_max);
}
...
void Leitura(){
        ...
        if(Permitido) acessoLiberado(); //Se a variável Permitido for verdadeira será chamada a função acessoLiberado()        
